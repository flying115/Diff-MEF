...
class GaussianDiffusionTrainer(nn.Module):
    ...
    def forward(self, ue_image, oe_image, gt_image, text_emb, ue_seg, oe_seg, epoch):
        ...
        loss_denoise = loss_mse + 2 * torch.mean(ssim_loss(y_0_pred, gt_image, window_size=11)) + F.l1_loss(y_0_pred, gt_image)
        ...
        loss =  4 * loss_ssim  +  5 * loss_l1 + 10 * loss_grad + loss_color + 0.01 * loss_text
